...
import {
  ...
  HeaderProps, HeaderStyleInterpolator,
  HeaderTitle,
} from 'react-navigation-stack';
import {HeaderLayoutPreset, Scene, SceneInterpolatorProps} from 'react-navigation-stack/lib/typescript/types';
import ModularHeaderBackButton from 'react-navigation-stack/lib/typescript/views/Header/ModularHeaderBackButton';
...
class MyHeader extends React.PureComponent<HeaderProps, State> {
  ...
  private renderLeft = (props: SubviewProps) => {
    ...
    if (
      ...
      return this.renderModularSubView(
        ...
        HeaderStyleInterpolator.forLeftLabel,
        HeaderStyleInterpolator.forLeftButton
      );
    }
  };
  ...
  render() {
    ...
    return (
      <Animated.View
        style={[
          HeaderStyleInterpolator.forLayout(this.props),
...
export default Object.assign(withOrientation(MyHeader), {
  get HEIGHT() {
